...
INFRASTRUCTURE_AND_MANAGEMENT_PRACTICE_DIR=$(PRACTICE_DIR)/5_infrastructure_and_management_practices
...
.PHONY: plantuml_infrastructure
plantuml_infrastructure:
	plantuml -o ./images/ -t png -overwrite $(INFRASTRUCTURE_AND_MANAGEMENT_PRACTICE_DIR)/uml/*.puml
